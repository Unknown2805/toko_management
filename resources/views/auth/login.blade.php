...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/logo/5.jpg" type="image/x-icon">
    <link rel="shortcut icon" href="assets/images/logo/5.jpg" type="image/jpg">
</head>
        ...
        <div class="row">
                ...
                <div id="auth-left">
                    ...
                    <form method="POST" need-validation action="{{ route('login') }}">
                        ...
                        <div class="text-center">
                            <h5>
                                <div class="text-center">
                                    <img src="assets/images/logo/logo.svg" class="avatar-xl mb-2" alt="Logo"
            ...
            <div class="col-lg-7 d-none d-lg-block">
                <div id="auth-right">
                    ...
                    <img src="assets/images/faces/coba1.jpg" width="700px" height="650px">
                </div>
            </div>
        </div>
